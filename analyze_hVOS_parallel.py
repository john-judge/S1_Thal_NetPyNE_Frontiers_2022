...
if 'scnn1a' in hVOS_pop_choice:
    print("Targeting scnn1a excitatory neurons")
    target_hVOS_populations = ["L4_SS", "L4_PC"]
...
for cell_id in loaded_compart_data.hash_map.keys():
    ...
    if me_type not in me_type_morphology_map:
        ...
        except ValueError: # example: L6_TPC_L4_cAD
            me_type_part1, me_type_part2, me_type_part3, me_type_part4 = me_type.split("_")
            m_type, e_type = me_type_part1 + "_" + me_type_part2+ "_" + me_type_part3, me_type_part4
